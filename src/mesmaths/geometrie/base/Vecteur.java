...
public class Vecteur {
    ...
    public static Vecteur difference(Vecteur u, Vecteur v) {
        return u.difference(v);
    }
    ...
    public static double produitScalaire(Vecteur u, Vecteur v) {
        return u.produitScalaire(v);
    }

    public static double determinant(Vecteur u, Vecteur v) {
    ...
    public Vecteur somme(Vecteur u) {
    ...
    public Vecteur difference(Vecteur u) {
        return this.somme(u.oppose());
    }

    /**
     * realise this = this + u
     */
    public void ajoute(Vecteur u) {
        this.x += u.x;
        this.y += u.y;
    }
     ...
     * realise this = r * this
     */
    public void multiplie(double r) {
        this.x *= r;
        this.y *= r;
    }
